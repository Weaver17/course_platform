...
CREATE TYPE "public"."lesson_status" AS ENUM('public', 'private');--> statement-breakpoint
...
ALTER TABLE "lessons" ADD CONSTRAINT "lessons_sectionId_courses_id_fk" FOREIGN KEY ("sectionId") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
